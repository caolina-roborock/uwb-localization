...
if(slam_pp_CONFIG_INCLUDED)
  return()
endif()
set(slam_pp_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(slam_pp_SOURCE_PREFIX /home/lina/RoboRock/project/Scruber/uwb-localization/src/slam_pp)
  set(slam_pp_DEVEL_PREFIX /home/lina/RoboRock/project/Scruber/uwb-localization/src/cmake-build-debug/devel)
  set(slam_pp_INSTALL_PREFIX "")
  set(slam_pp_PREFIX ${slam_pp_DEVEL_PREFIX})
else()
  set(slam_pp_SOURCE_PREFIX "")
  set(slam_pp_DEVEL_PREFIX "")
  set(slam_pp_INSTALL_PREFIX /usr/local)
  set(slam_pp_PREFIX ${slam_pp_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'slam_pp' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND slam_pp_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lina/RoboRock/project/Scruber/uwb-localization/src/cmake-build-debug/devel/lib;/home/lina/RoboRock/project/Scruber/carto_ws/install_isolated/lib;/home/lina/RoboRock/project/Scruber/RoboScrub_Nav/devel/lib;/home/lina/RoboRock/project/Scruber/RoboScrub_RockNavigation/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(slam_pp_LIBRARY_DIRS ${lib_path})
      list(APPEND slam_pp_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'slam_pp'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND slam_pp_LIBRARIES ${lib})
    endif()
  endif()
...
set(slam_pp_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${slam_pp_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "common_msgs;roscpp;rospy;std_msgs;tf;pcl_conversions")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 slam_pp_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${slam_pp_dep}_FOUND)
      find_package(${slam_pp_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${slam_pp_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(slam_pp_INCLUDE_DIRS ${${slam_pp_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(slam_pp_LIBRARIES ${slam_pp_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${slam_pp_dep}_LIBRARIES})
  _list_append_deduplicate(slam_pp_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(slam_pp_LIBRARIES ${slam_pp_LIBRARIES})

  _list_append_unique(slam_pp_LIBRARY_DIRS ${${slam_pp_dep}_LIBRARY_DIRS})
  list(APPEND slam_pp_EXPORTED_TARGETS ${${slam_pp_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${slam_pp_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
